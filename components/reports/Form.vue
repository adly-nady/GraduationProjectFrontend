<template>
    ...
    <form action=""
        ...
        <div class="w-[95%] flex  p-1 rounded-lg justify-around items-center bg-[#D9D9D9]">
            <!-- <div v-for="input in props.formField" :key="input.name" class="flex justify-center items-center gap-1">
